...
<div class="well">
<button class="btn btn-primary">Оставьте заявку</button> или позвоните нам (номер телефона).
</div>
...
Остались вопросы? Проконсультируйтесь с кадастровым инженером (номер телефона).
